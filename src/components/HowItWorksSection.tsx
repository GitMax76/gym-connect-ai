        ...
        <section className="py-20 bg-slate-50">
            <div className="container mx-auto px-4">
                ...
                <div className="relative max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 flex flex-col items-center text-center relative hover:-translate-y-2 transition-transform duration-300">
                            <div className="w-20 h-20 bg-green-100 text-green-600 rounded-full flex items-center justify-center mb-6 text-3xl shadow-sm border-4 border-white">
                        ...
                        {/* Step 2: FitCoin */}
                        <div className="bg-gradient-to-b from-blue-50 to-white p-8 rounded-2xl shadow-lg border border-blue-100 flex flex-col items-center text-center relative hover:-translate-y-2 transition-transform duration-300 transform scale-105 z-10">
                            <div className="absolute top-0 right-0 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-bl-xl rounded-tr-xl">
                                Novità
                            </div>
                            <div className="w-20 h-20 bg-blue-600 text-white rounded-full flex items-center justify-center mb-6 text-3xl shadow-lg border-4 border-blue-100">
                            ...
                            <div className="mt-auto bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                                + Vantaggi
                            </div>
                        </div>
                        ...
                        {/* Step 3: Train */}
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 flex flex-col items-center text-center relative hover:-translate-y-2 transition-transform duration-300">
                            <div className="w-20 h-20 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center mb-6 text-3xl shadow-sm border-4 border-white">
                            ...
                            <div className="mt-auto bg-orange-100 text-orange-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                                Flessibile
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-20 bg-slate-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-green-500 rounded-full blur-[100px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="md:w-1/2 flex justify-center">
                            ...
                            <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-2xl border border-slate-700 shadow-2xl max-w-sm w-full">
                                ...
                                <div className="text-5xl font-bold text-white mb-2">150 <span className="text-green-400">FC</span></div>
                                <div className="text-sm text-green-400 mb-8">+15 FC Bonus ottenuti</div>
